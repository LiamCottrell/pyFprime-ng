...
"""
    ...
    def DrawPanel(self):
        ...
        self.Results = wx.TextCtrl(
            parent=self.panel, style=wx.TE_MULTILINE | wx.TE_DONTWRAP
        )
        ...
        if self.Elems:
            ...
            lablSizer.Add(
                wx.StaticText(parent=self.panel, label="Chemical Formula:"),
                0,
        ...
        selSizer.Add((5, 10), 0)
        selSizer.Add(
            wx.StaticText(parent=self.panel, label="Wavelength:"),
            0,
        ...
        selSizer.Add(
            wx.StaticText(parent=self.panel, label="Energy:"),
            0,
            wx.ALIGN_CENTER_VERTICAL | wx.EXPAND,
        )
        selSizer.Add((5, 10), 0)
        ...
        selSizer.Add(
            wx.StaticText(parent=self.panel, label="Plot scale:"),
            0,
            wx.ALIGN_CENTER_VERTICAL | wx.EXPAND,
        )
        selSizer.Add((5, 10), 0)
        ...
        cellSizer.Add(
            wx.StaticText(parent=self.panel, label="Volume:"),
            0,
            wx.ALIGN_CENTER_VERTICAL | wx.EXPAND,
        )
        cellSizer.Add((5, 10), 0)
        self.SpinText3 = wx.TextCtrl(
            id=wxID_SPINTEXT3,
            parent=self.panel,
            size=wx.Size(100, 20),
        ...
        cellSizer.Add((5, 10), 0)
        cellSizer.Add(
            wx.StaticText(parent=self.panel, label="Z(vol):"),
            0,
            wx.ALIGN_CENTER_VERTICAL | wx.EXPAND,
        )
        cellSizer.Add((5, 10), 0)
        self.SpinText4 = wx.TextCtrl(
            id=wxID_SPINTEXT4,
            parent=self.panel,
            size=wx.Size(50, 20),
            value="%d" % (self.Zcell),
        ...
        cellSizer.Add((5, 10), 0)
        cellSizer.Add(
            wx.StaticText(parent=self.panel, label="Sample R:"),
            0,
            wx.ALIGN_CENTER_VERTICAL | wx.EXPAND,
        )
        cellSizer.Add((5, 10), 0)
        self.SpinText5 = wx.TextCtrl(
            id=wxID_SPINTEXT5,
            parent=self.panel,
            size=wx.Size(50, 20),
        ...
        cellSizer.Add((5, 10), 0)
        cellSizer.Add(
            wx.StaticText(parent=self.panel, label="packing:"),
            0,
            wx.ALIGN_CENTER_VERTICAL | wx.EXPAND,
        )
        cellSizer.Add((5, 10), 0)
        self.SpinText6 = wx.TextCtrl(
            id=wxID_SPINTEXT6,
            parent=self.panel,
            size=wx.Size(50, 20),
            value="%.2f" % (self.Pack),
    ...
    def SetWaveEnergy(self, Wave):
        ...
        if self.Volume:
            ...
            Text += "%s%10.2f%s" % (
                "Total " + Gkmu + "R=",
                self.Radius * self.Pack * muT / (10.0 * self.Volume),
                ", ",
            )
            Text += "%s%10.4f%s\n" % (
                "Transmission exp(-2" + Gkmu + "R)=",
                100.0
                * math.exp(-2 * self.Radius * self.Pack * muT / (10.0 * self.Volume)),
                "%",
            )
